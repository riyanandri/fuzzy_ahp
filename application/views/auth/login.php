...
<head>
	...
	<title>Login &mdash; Fuzzy AHP</title>
			...
			<div class="col-xxl-4 col-xl-5 col-lg-6 col-md-7 col-sm-8">
				<div class="card shadow-lg">
					<div class="card-body p-4">
						...
						?>
						<form method="POST" action="<?php echo base_url(); ?>/login/proses" class="needs-validation" novalidate="" autocomplete="off">
							<div class="mb-3">
								<label class="mb-2 text-muted" for="email">E-Mail Address</label>
								<div class="input-group input-group-join mb-3">
									<input id="email" type="email" placeholder="Enter Email" class="form-control" name="email" id="email" required autofocus>
					...
					<div class="card-footer py-3 border-0">
						<div class="text-center">
							Don't have an account yet? <a href="<?php echo base_url('register'); ?>" class="text-dark">Create an account</a>
						</div>
					</div>
				</div>
