						...
						<div class="card">
							...
							<div class="card-body">
								<form method="POST" action="">
									<div class="row">
										<input type="hidden" name="id" id="id" value="<?php echo $alternatif->id; ?>" />
										<div class="col-md-12">
											<div class="mb-3">
												<label for="basicInput" class="form-label">Kode</label>
												<input class="form-control <?php echo form_error('kode') ? 'is-invalid' : '' ?>" type="text" placeholder="masukkan kode" name="kode" value="<?php echo $alternatif->kode; ?>">
										...
										<div class="col-md-12">
											<div class="mb-3">
												...
												<input class="form-control <?php echo form_error('nama_alternatif') ? 'is-invalid' : '' ?>" type="text" placeholder="masukkan nama alternatif" name="nama_alternatif" value="<?php echo $alternatif->nama_alternatif; ?>">
												<div class="invalid-feedback">
										...
										<div class="col-md-12">
											<div class="mb-3">
												...
												<textarea class="form-control <?php echo form_error('keterangan') ? 'is-invalid' : '' ?>" name="keterangan" id="keterangan" rows="3"><?php echo $alternatif->keterangan; ?></textarea>
												<div class="invalid-feedback">
