					...
					<div class="col-md-12">
						...
						<div class="card">
							<div class="card-header">
								<a href="<?php echo site_url('alternatif/add') ?>"><button type="button" class="btn mb-2 icon-left btn-primary "><i class="ti-plus"></i>Tambah data</button></a>
							</div>
							<div class="card-body">
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td>
													<a href="<?php echo site_url('alternatif/edit/' . $a->id) ?>"><button type="button" class="btn btn-warning btn-sm"><i class="ti-pencil"></i> Edit</button></a>
													<a onclick="deleteConfirm('<?php echo site_url('alternatif/delete/' . $a->id) ?>')" href="#!"><button type="button" class="btn btn-danger btn-sm hapus" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="ti-trash"></i> Hapus</button></a>
												</td>
											</tr>
										<?php
										}
