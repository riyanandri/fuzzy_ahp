				...
				<div class="row same-height">
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<form method="POST" action="<?php echo site_url('kriteria/add') ?>">
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
										...
										<div class="col-md-12">
											<div class="mb-3">
												...
												<input class="form-control <?php echo form_error('nama_kriteria') ? 'is-invalid' : '' ?>" type="text" placeholder="masukkan nama kriteria" name="nama_kriteria">
												<div class="invalid-feedback">
